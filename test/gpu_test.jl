...
fb = SIGPROC.fake_pulse(300, f_max, f_min; samples=n_samp, channels=n_chan,w=5,t_step=δt,dtype=UInt16)
...
empty_pxl = Float32(mean(pulse)) * n_chan
output = CUDA.fill(empty_pxl,n_samp, n_dm)
